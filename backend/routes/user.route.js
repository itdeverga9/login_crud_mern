...
router.post(
    ...
    body("username")
        ...
        .isLength({ min: 6 }).withMessage("username minimum is 6 characters")
        .custom(async value => {
    ...
    body("password")
        ...
        .isLength({ min: 6 }).withMessage("password minimum is 6 characters"),
    body("confirmPassword")
        .exists().withMessage("confirmPassword is required")
        .isLength({ min: 6 }).withMessage("confirmPassword minimum 8 characters")
        .custom((value, { req }) => {
...
router.put(
    ...
    body("newPassword")
        ...
        .isLength({ min: 6 }).withMessage("new password minimum is 6 characters"),
